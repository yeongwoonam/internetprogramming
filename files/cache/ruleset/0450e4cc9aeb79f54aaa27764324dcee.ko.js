...
v.cast('ADD_FILTER',['install', {'email_address':{required:true,rule:'email',minlength:'1',maxlength:'200'},'password':{required:true,minlength:'1',maxlength:'60'},'password2':{required:true,minlength:'1',maxlength:'60'},'nick_name':{required:true,minlength:'2',maxlength:'20'},'user_id':{required:true,rule:'userid',minlength:'2',maxlength:'20'}}]);
